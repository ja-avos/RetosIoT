...
def get_max_measure_date(*args, measurement, date):
    """
    Trae la medición máxima de una variable en una fecha específica {date, city, measurement}.
    La fecha es por día y tiene formato AAAA-MM-DD. Ej: 2021-12-01.
    Se escoge el máximo de todas las mediciones desde las 00:00:00 hasta las 23:59:59 de esa fecha.
    Retorna el máximo de esas mediciones por ciudad en un JSONResponse.
    """
    ...
    results = Data.objects.filter(
        measurement=measurement_db, time__gte=start, time__lt=end
